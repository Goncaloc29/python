...
# curso.cores() # AttributeError

print(help(print)) - A função help() é uma função integrada (Built-in) do Python que serve para exibir a documentação/como utilizar os parâmetros/atributos/métodos disponíveis para determinada função ou tipo de dado.
