...
# cidade.append('Campo Grande')
# cidade.append('Cuiabá')
# cidade.append('Campo Grande')
# cidade.append('Cuiabá')
# cidade.append('Campo Grande')
# cidade.append('Cuiabá')
...
# O que você faria? Faria um loop na lista para verificar se cada valor existe na lista? Isso seria trabalhoso. Mas Python tem uma solução mais elegante para isso, utilizando Sets.

# Forma 1 - Utilizando o construtor Set
# cidade = set(cidade)
# print(cidade)
# print(len(cidade))
